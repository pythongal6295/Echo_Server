...
def client(msg, log_buffer=sys.stderr):
    ...
    try:
        ...
        # TODONE: the server should be sending you back your message as a series
        ...
        # TODONE: after you break out of the loop receiving echoed chunks from
        #       the server you will want to close your client socket.
        sock.close()
        print('closing socket', file=log_buffer)

        # TODONE: when all is said and done, you should return the entire reply
