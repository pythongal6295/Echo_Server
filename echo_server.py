...
def server(log_buffer=sys.stderr):
    ...
    # TODONE: You may find that if you repeatedly run the server script it fails,
    ...
    # TODONE: bind your new sock 'sock' to the address above and begin to listen
    ...
    try:
        ...
        while True:
            ...
            # TODONE: make a new socket when a client connects, call it 'conn',
            ...
            try:
                ...
                while True:
                    ...
                    # TODONE: receive 16 bytes of data from the client. Store
                    ...
                    buffer_size = 16
                    received_chunk = conn.recv(buffer_size)
                    
                    data += received_chunk

                    print('received "{0}"'.format(data.decode('utf8')))
                    
                    # TODONE: Send the data you received back to the client, log
                    # the fact using the print statement here.  It will help in
                    # debugging problems.
                    conn.sendall(received_chunk)
                    print('sent "{0}"'.format(data.decode('utf8')))
                    
                    # TODONE: Check here to see whether you have received the end
                    ...
                    # :)
                    if len(received_chunk) < 16:
                        break
            except Exception as e:
                traceback.print_exc()
                sys.exit(1)
            finally:
                # TODONE: When the inner loop exits, this 'finally' clause will
        ...
        # TODONE: Use the python KeyboardInterrupt exception as a signal to
